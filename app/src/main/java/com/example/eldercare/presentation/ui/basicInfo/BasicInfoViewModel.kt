...
import com.example.eldercare.domain.usecase.proTected.PostProtectedRegistrationUseCase
import com.example.eldercare.domain.usecase.user.PostUserRegistrationUseCase
...
class BasicInfoViewModel
    @Inject
    constructor(
        private val postProtectedRegistrationUseCase: PostProtectedRegistrationUseCase,
        private val postUserRegistrationUseCase: PostUserRegistrationUseCase,
    ) : BaseViewModel() {
        // 연락처를 관리하는 리스트
        ...
        fun postUsersRegistration(
            ...
            viewModelScope.launch {
                postUserRegistrationUseCase.invoke(
                    username,
                    phoneNumber,
                    relationship,
                    userImageUrl,
        ...
        fun postProtectedRegistration(
            ...
            viewModelScope.launch {
                postProtectedRegistrationUseCase.invoke(
                    protectedName,
                    protectedBirthDate,
