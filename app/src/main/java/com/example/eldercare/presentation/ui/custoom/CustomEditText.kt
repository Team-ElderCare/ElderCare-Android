...
class CustomTextField @JvmOverloads constructor(
    ...
    init {
        ...
        binding.clTextField.setBackgroundResource(R.drawable.custom_textfield_background)
    ...
    fun setError(message: String) {
        binding.clTextField.setBackgroundResource(R.drawable.custom_textfield_background_error)
