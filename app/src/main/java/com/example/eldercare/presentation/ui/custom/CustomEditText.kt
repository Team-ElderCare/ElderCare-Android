...
class CustomEditText @JvmOverloads constructor(
    ...
    private fun setupTextWatcher() {
        binding.etInputField.addTextChangedListener(object : TextWatcher {
    ...
    private fun updateVisibility(unitVisible: Boolean, clearButtonVisible: Boolean) {
    ...
    private fun updateConstraints(clearButtonVisible: Boolean, searchButtonVisible: Boolean, dropdownButtonVisible: Boolean, unitVisible: Boolean) {
    ...
    fun setDropdownOptions(options: List<String>, onOptionSelected: (String) -> Unit) {
